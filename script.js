document.addEventListener('DOMContentLoaded', () => {
  ...
  const voltagePhasesChart = new Chart(ctxPhaseVolt, {
    ...
    data: {
        labels: [],
        datasets: [
            { label: 'Fase A-B', data: [], borderColor: '#ffc107', borderWidth: 2, fill: true, backgroundColor: gradVAB },
            { label: 'Fase B-C', data: [], borderColor: '#28a745', borderWidth: 2, fill: true, backgroundColor: gradVBC },
            { label: 'Fase C-A', data: [], borderColor: '#17a2b8', borderWidth: 2, fill: true, backgroundColor: gradVCA }
        ]
    },
    options: {
        ...commonOptions,
  ...
  const voltageLNChart = new Chart(ctxPhaseVoltLN, {
    ...
    data: {
        labels: [],
        datasets: [
            { label: 'Fase A-N', data: [], borderColor: '#ffc107', borderWidth: 2, fill: true, backgroundColor: gradVAN },
            { label: 'Fase B-N', data: [], borderColor: '#28a745', borderWidth: 2, fill: true, backgroundColor: gradVBN },
            { label: 'Fase C-N', data: [], borderColor: '#17a2b8', borderWidth: 2, fill: true, backgroundColor: gradVCN }
        ]
    },
    options: {
        ...commonOptions,
  ...
  const currentPhasesChart = new Chart(ctxCurrPhases, {
    ...
    data: {
        labels: [],
        datasets: [
            { label: 'Fase A', data: [], borderColor: '#ffc107', borderWidth: 2, fill: true, backgroundColor: gradCurA },
            { label: 'Fase B', data: [], borderColor: '#28a745', borderWidth: 2, fill: true, backgroundColor: gradCurB },
            { label: 'Fase C', data: [], borderColor: '#17a2b8', borderWidth: 2, fill: true, backgroundColor: gradCurC }
        ]
    },
    options: {
        ...commonOptions,
  ...
  const currentNGChart = new Chart(ctxCurrNG, {
    ...
    data: {
        labels: [],
        datasets: [
            { label: 'Neutro (N)', data: [], borderColor: '#17a2b8', borderWidth: 2, fill: true, backgroundColor: gradCurN },
            { label: 'Tierra (G)', data: [], borderColor: '#6c757d', borderWidth: 2, fill: true, backgroundColor: gradCurG }
        ]
    },
    options: {
        ...commonOptions,
        ...
        if (json.contenido_csv) {
            ...
            lines.forEach(line => {
                ...
                if (parts.length >= 4) {
                    ...
                    if (tbody) {
                        const row = tbody.insertRow();
                        const bgStyle = isTrue ? 'background-color: rgba(220, 53, 69, 0.05);' : '';
                        row.innerHTML = `<td style="padding: 8px; border-bottom: 1px solid #ddd; ${bgStyle}">${timestamp}</td><td style="padding: 8px; border-bottom: 1px solid #ddd; ${bgStyle}">${type}</td><td style="padding: 8px; border-bottom: 1px solid #ddd; ${bgStyle}">${valStr}</td><td style="padding: 8px; border-bottom: 1px solid #ddd; ${bgStyle}">${event}</td><td style="padding: 8px; border-bottom: 1px solid #ddd; ${bgStyle}; font-weight:bold;">${durationStr}</td>`;
                    }
                }
            });
        } 
